...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Create driving mode buttons for the sidebar in manual mode
        ...
        self.manual_mode_sidebar_layout.addWidget(self.auto_mode_button)
        self.manual_mode_sidebar_layout.addWidget(self.manual_mode_button)
        ...
        self.manual_mode_video_layout.addWidget(self.manual_mode_title_label)
        self.manual_mode_video_layout.addWidget(self.video_label)
        self.manual_mode_video_layout.addWidget(self.manual_mode_exit_button)
